...
#input parameters
first_spl=[0,30,50,70]      #inputting initial dB for first half of simulation
second_spl=[30,50,70]       #inputting second dB for second half of simulation
                            #each first_spl will be run with each second_spl outputting convolution plots for each combination (e.g. 0,30; 0,50; 0,70; 30,30; etc)
trial_no=3                  #num trials

#runs for both normal myelin (Lu_min = Lu_max = 10.0) and random demyelination between 10 and 20 um
length_Lu_max=[10.0, 20.0]
length_Lu_min=[10.0, 10.0]
length_Lh_max=[1.0, 1.0]
length_Lh_min=[1.0, 1.0]
color=["red","blue"]        #normal myelination is red, random demyelination is blue on plot
freq=int(sys.argv[1])
time_all = 7                #full duration of simulation


#loops automating plotting so you don't need to run the code over and over
